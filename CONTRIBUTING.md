...
- `packages/api-mocks`: Auto-generated vitest mocks for `@podman-desktop/api`, published as `@podman-desktop/api-mocks` so third-party extensions can use them in their own tests.
